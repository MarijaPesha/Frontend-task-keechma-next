...
(defclassified HomepageWrapper :div "font-open-sans h-screen w-screen flex flex-col bg-gray-200 overflow-x-hidden overflow-y-scroll")

;;TASK componentize preloader
(defnc Preloader [props]
       (d/div {:className "bg-gray-200 w-screen h-screen overflow-hidden flex items-center justify-center"}
              (d/img {:width  "128"
                      :height "128"
                      :alt    "Loading"
...
(defnc HomeRenderer [props]
       (let [feed-data (:feed (use-sub props :feed))
         ...
         ($ HomepageWrapper
            ...
            (if loading-feed
              ...
              (<>
                ...
                (d/div {:class "bg-gray-100 flex flex-1 flex-col items-center justify-center px-6 md:px-12 w-full md:w-3/5 mx-auto shadow-xl py-12"}
                         ...
                         (fn [item]
                           (d/div {:key       (:id item)
                                  ...
                                  (d/div {:className "cursor-pointer text-left w-3/4 ml-4"}
                                         ...
                                         (d/p {:className "text-gray-700 text-sm mt-4"}
